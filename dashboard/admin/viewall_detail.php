         ...
         <tbody><tr>
           <td height="35">
			 ...
			 <tr>
               ...
               <td height="35"><input type="text" id="boxxe" readonly="" value='<?php echo $Group_name?>'></td>
             </tr>
			 <tr>
               <td height="35">TRAINER ID:</td>
               <td height="35"><input type="text" readonly="" id="boxxe" value='<?php echo $trainer_id?>'></td>
             </tr>
			 <tr>
               <td height="35">trainer_name:</td>
               <td height="35"><input type="text" readonly="" value='<?php echo $trainer_name?>' id="boxxe"></td>
             </tr>
			 <tr>
               <td height="35">contact:</td>
               <td height="35"><input type="text" readonly="" id="boxxe" value='<?php echo $contact?>'></td>
             </tr>
			 <tr>
