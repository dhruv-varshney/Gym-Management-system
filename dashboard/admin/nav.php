...
<ul id="main-menu" class="" >
	...
	<li id="health_status"><a href="new_health_status.php"><i class="entypo-user-add"></i><span>TRAINER ALLOCATED</span></a> 	
	...
	<li class="" id="routinehassubopen"><a href="#" onclick="memberExpand(4)"><i class="entypo-alert"></i><span>Exercise WorkOut</span></a>

		<ul id="routineExpand">
			<li class="active">
				<a href="addworkoutlog.php"><span>Add Workout</span></a>
			</li>

			<li>
				<a href="editworkoutlog.php"><span>Edit WorkOut</span></a>
			</li>

			<li>
				<a href="viewworkoutlog.php"><span>View WorkOut</span></a>
			</li>
