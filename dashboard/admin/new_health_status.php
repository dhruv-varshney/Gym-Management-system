...
<head>
	...
	<title>Star Gym | TRAINER ALLOCATED</title>
							    ...
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        if (mysqli_affected_rows($con) == 1) {
							            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
							                ...
							                <input type='hidden' name='ugender' value='" . $ugender . "'/><input type='submit' class='a1-btn a1-blue' id='button1' value='See Trainer' class='btn btn-info'/></form></td></tr>";
							                $msgid = 0;
							            }
							        }
							    }
