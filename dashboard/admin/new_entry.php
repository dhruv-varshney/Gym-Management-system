      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
        ...
        <tr>
               ...
               <td height="35"><input type="text" name="trans_id" id="boxx" required size="30"></td>
             </tr>
        <tr>
               <td height="35">MODE:</td>
               <td height="35"><input type="text" name="mode" id="boxx" required size="30"></td>
             </tr> 
             <tr>
