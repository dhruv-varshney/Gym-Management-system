...
$query="insert into users(username,gender,mobile,email,dob,joining_date,trans_id,mode,userid) values('$uname','$gender','$phn','$email','$dob','$jdate','$trans_id','$mode','$memID')";
    if(mysqli_query($con,$query)==1){
      ...
      $result=mysqli_query($con,$query1);
        ...
        if($result){
          ...
          $d=strtotime("+".$value[3]."month",strtotime($jdate));
          ...
          //inserting into enrolls_to table of corresponding userid
                    $query2="insert into enrolls_to(pid,uid,paid_date,expire,renewal,trans_id,mode) values('$plan','$memID','$cdate','$expiredate','yes','$trans_id','$mode')";
          if(mysqli_query($con,$query2)==1){

            $query4="insert into trainer_allocated(uid) values('$memID')";
