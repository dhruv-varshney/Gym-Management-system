...
<head>
    ...
    <title>Star Gym | Make Payment</title>
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="submit_payments.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               <td height="35">TRANSACTION ID</td>
               <td height="35"><input type="text" name="trans_id" id="boxx" value="<?php echo $trans_id; ?>"></td></td>
             </tr>
             <tr>
               <td height="35">MODE</td>
               <td height="35"><input type="text" name="mode" id="boxx" value="<?php echo $mode; ?>" ></td></td>
             </tr>
             <tr>
